...
// flag
$sql="CREATE TABLE security.flagtext
		(
		id int(3)NOT NULL AUTO_INCREMENT,
	...
	if (mysql_query($sql))
		{echo "successfully"; echo "<br><br>\n";}
	else 
		{echo "Error creating Table: " . mysql_error();echo "<br><br>\n";}
$sql="INSERT INTO `security`.`flagtext` (id, flag) VALUES ('1', 'flag{text}')";
	if (mysql_query($sql))
		{echo "Inserted data correctly  into table 'EMAILS'";echo "<br><br>\n";}
	else 
		{echo "Error inserting data: " . mysql_error();echo "<br><br>\n";}
...
system("mv ../index.html.bak ../index.html");
